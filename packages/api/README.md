...
The API is documented as an OpenAPI (Swagger) YAML file at [docs/openapi.yaml](docs/openapi.yaml).
...
- `ALLOWED_USERS`: Optional comma-separated allowlist of Auth0 user `sub` values and/or (case-insensitive) email addresses.
